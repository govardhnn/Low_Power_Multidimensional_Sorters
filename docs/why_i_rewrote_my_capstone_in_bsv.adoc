...
== Wait how does the gate-count compare BSV vs Verilog implementation?
...
A staggering *25.65%* reduction in number of cells - using a language much abstract, intuitive and efficient. 
