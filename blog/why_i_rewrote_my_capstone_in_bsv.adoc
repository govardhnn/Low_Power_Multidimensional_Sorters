...
image::./img/CAE.png[width=40%,align=center,title="The Compare and Exchange (CAE) Block"]
...
image::./img/BM8.png[width=50%,align=center,title="The Bitonic Merge Sorting Network"]
...
image::./img/BM4.png[width=10%,align=center,title="The BM4 sorter Network"]
...
image::./img/MDSA.png[width=50%,align=center,title="The block diagram of the MDSA Architecture"]

==== MDSA Agorithm FSM

image::./img/MDSA_FSM.png[width=50%,align=center,title="The FSM that implements the MDS-Algorithm"]
...
image::./img/MDSA_FSM_P1.png[width=50%,align=center,title="The First Phase of the MDSA Algorithm"]
...
image::./img/MDSA_FSM_P2.png[width=50%,align=center,title="The Second Phase of the MDSA Algorithm"]
...
NOTE: You can disable the $display statements from being generated in the verilog generation phase by removing the define `-D DISPLAY` in the Makefile
...
=== _There you go! A reduction in gate-count from *121k* to *90k*._ A staggering *25%* reduction in number of cells - using a language much abstract, intuitive and efficient. 
