...
Date: (Tentative)4th January, 2025

[.lead]
ifdef::backend-html5[]
++++
<style>
h1, h2, h3, h4, h5, h6, .title, div.title, .imageblock .title, .literalblock .title {
    color: blue;
    font-weight: bold;
}
</style>
...
==== _There you go! A reduction in gate-count from *121k* to *90k*._ 

A staggering *25%* reduction in number of cells - using a language much abstract, intuitive and efficient. 

=== Scope of future contribution to this project(TODO)
