...
=== The MDSA Implementation

image::./img/MDSA.png[width=50%,title="The block diagram of the MDSA Architecture"]

The MDSA's algorithm efficiently uses Parallel Hardware Sorter Arrays(PHSAs) like the Bitonic sorter we earlier designed to specify an architecture that uses eight such units 
